...
async function cargarBlog() {
    try {
        ...
        for (const archivo of archivosJSON) {
            ...
            const carouselItemsHTML = imagenes.map((img, index) =>  `<div class="carousel-item ${index === 0 ? 'active' : ''}">      <img src="${img}" class="d-block w-100" alt="${post.title} - imagen ${index + 1}">  </div>` ).join('');
            
            tarjeta.innerHTML = `
                <div class="activity-card">
                    <img class="activity-image" src="${post.image}" alt="${post.title}">
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl"> <div class="modal-content border-0 shadow-lg"> <div class="modal-body p-0"> <div class="row g-0">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-4 p-4 d-flex flex-column justify-content-between">
                            ...
                            <p class="text-muted small mb-3">Categoría / Fecha</p>
